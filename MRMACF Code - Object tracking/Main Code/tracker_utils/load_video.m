...
if strcmp(sequence_name, 'Football1')
...
elseif strcmp(sequence_name, 'David')
    nn = 300;
elseif strcmp(sequence_name, 'Tiger1')
    nn = 06;
else
    nn = 1;
end
...
%TC
% if strcmp(sequence_name,'Busstation_ce2')
%     nn=6;
% elseif strcmp(sequence_name, 'David')
%     nn = 300;
...
switch seq.format
    case 'rect_4'
        ...
        elseif exist([img_path num2str(nn, 'img%06i.jpg')], 'file')
